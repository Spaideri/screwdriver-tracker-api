INSERT INTO event (tracker_id, version, submitTime, eventTimestamp) VALUES (
  (SELECT id FROM tracker WHERE trackerCode = 'TEST_TRACKER_1'), '1', NOW(), TIMESTAMP '2015-03-01 10:00:00');
...
INSERT INTO event (tracker_id, version, submitTime, eventTimestamp) VALUES (
  (SELECT id FROM tracker WHERE trackerCode = 'TEST_TRACKER_1'), '1', NOW(), TIMESTAMP '2015-03-02 12:01:00');
